...
### 👨‍🎓 Aluno(a)
- [CAIO CÉSAR SILVA MENIN](https://www.linkedin.com/in/caio-menin-875026306/)
...
**Resultados Documentados em `prints/RIPng/`:**
...
**Resultados Documentados em `prints/EIGRPv6/`:**
- Interfaces IPv6 configuradas
...
**Resultados Documentados em `prints/OSPFv3/`:**
- Interfaces IPv6 configuradas
- Vizinhos OSPF
...
3. **Configure o protocolo desejado** usando os arquivos em `configs/` como referência
...
✅ **Todos os roteadores conseguem fazer ping entre as loopbacks**
✅ **Tabela de rotas exibe rotas aprendidas pelo protocolo**
✅ **Vizinhanças formadas entre roteadores adjacentes**
...
│   └── projeto base.pkt               # Topologia base (sem configuração)
│
├── prints/                             # Documentação visual (capturas de tela)
│   ├── RIPng/
...
- [x] Arquivos de configuração documentados em `configs/`
- [x] Capturas de tela dos comandos em `prints/`
...
|--------|------|-----------|
| v1.0.0 | 15/11/2025 | Conclusão do projeto com documentação completa |
| v0.9.0 | 14/11/2025 | Implementação final do OSPFv3 e testes |
| v0.7.0 | 12/11/2025 | Implementação do EIGRPv6 |
| v0.5.0 | 10/11/2025 | Implementação do RIPng |
| v0.1.0 | 08/11/2025 | Criação da topologia base |
